...
# L’écran mobile : de la mobilité du lecteur à la lecture-mouvement.
...
\
Fig. 5 : Anthony Panie, _Scrample _(_<div> in_, 2017-18). Détails de la recherche sur la grille qui sera retenue comme principe de navigation sonore et extrait du carnet de recherche. Image ARC Édition nouvelles formes Ésad Orléans.
...
Fig. 6 : Martin Foucault, _Incidences médiatiques _(_<div> in_, 2017-18). Les actions proposées à l’utilisateur sont synthétisées par les icônes de navigation dans le texte. Image ARC Édition nouvelles formes Ésad Orléans.
...
Fig. 7 : Erwan Roussel, _Drawing Against You_ (_<div> in_, 2017-18). Détail de l’un des différents dispositifs de contraintes conçus par l’étudiant pour explorer de nouvelles formes d’interactions venant contrarier et renouveler la pratique du dessin. Image ARC Édition nouvelles formes Ésad Orléans.
